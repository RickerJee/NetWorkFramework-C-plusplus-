...
//chat_server_init("127.0.0.1", 8080, "D:\\Working\\Projects\\BeastDemo\\x64\\Debug", 1);

int chat_server_init(const std::string& address_,uint16_t port,const std::string& doc_root,int threads)
{
