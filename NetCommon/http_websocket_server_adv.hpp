...
//http_server_adv_init("127.0.0.1", 8080, "D:\\Working\\Projects\\BeastDemo\\x64\\Debug", 1);

void http_server_adv_init(const std::string& address_, uint16_t port, const std::string& doc_root_, int threads)
{
	...
	auto const doc_root = std::make_shared<std::string>(doc_root_);
